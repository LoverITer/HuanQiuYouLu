	...
	<body>
		  <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>增加成功案例 <small class="m-l-sm"></small></h5>
...
<input type="hidden" name="action" value="saveAdd"/>
  <div class="form-group">
   ...
   <div class="col-sm-3">
    	 <input class="form-control" type="text" name="house"  placeholder="选择的项目">
    </div>
     <div class="col-sm-3">
  ...
  <div class="form-group ">
     ...
     <div class=col-sm-7>
       <input class="form-control" type="text" name="why"  placeholder="客户为什么选择项目">
     </div>
  </div>
  <div class="form-group ">
    ...
    <div class="col-sm-12">
    	...
    	<textarea name="dis" class="form-control" id="txt1" style="height:200px;margin:20px 2px;"></textarea>
