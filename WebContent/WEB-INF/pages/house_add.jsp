<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="java.util.*,com.xzy.bean.*"%>
...
<html>
	...
	<head>
		...
		<style type="text/css">
			...
			ul.dowebok li input.labelauty+label {
				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content" style="font-size: 12px;">
							<!--内容开始-->
							<form class="form-horizontal" action="house" method="post">
								...
								<div class="form-group col-sm-8">
									...
									<div class="col-sm-6 col-md-7">
										<input type="text" name="keyword" class="form-control" value="" placeholder="多个关键字用逗号隔开">
									</div>
								</div>
								...
								<div class="form-group col-sm-4">
									...
									<div class="col-sm-6">
										<select name="priceRMB" class="form-control">
									...
									<div class="col-sm-6">
										<input type="text" name="priceOther" class="form-control" value="" placeholder="其它币XX万起">
									</div>
								</div>
								...
								<div class="form-group col-sm-6">
									...
									<div class=" col-sm-3 col-md-5">
										<div class="input-group">
											<input name="yjPersent" class="form-control" placeholder="拥金比例" value="20"> <span class="input-group-addon" id="basic-addon1">%</span>
										</div>
									</div>

									<div class=" col-sm-3 col-md-5">
										<div class="input-group">
											<input name="yjMany" class="form-control" placeholder="拥金"> <span class="input-group-addon" id="basic-addon1">万</span>
										</div>
									</div>
								...
								<div class="form-group col-sm-4">
									...
									<div class="col-sm-4 col-md-3">
										...
										<input type="hidden" value="" name="pic" id="pic_field" /> <img src="img/upload.jpg" width="68" height="57" style="cursor: pointer;" id="pic_id" />
										<script type="text/javascript">
											KindEditor
												.ready(function(K) {
													var editor = K
