        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem top_menu" href="admin?action=gotoWelcomePage">
                    ...
                    <li>
                        <a class="J_menuItem top_menu" href="article?action=gotoAritcleList">
                            <i class="fa fa-object-group"></i>
                            <span class="nav-label">资讯管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem top_menu" href="travel?action=index">
                            <i class="fa fa-bus"></i>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                          ...
                          <li>
                            ...
                            <li>
                                <a class="J_menuItem" href="admin">管理员管理</a>
                            </li>
                           
                        </ul>
                    </li>
                     <li>
                        <a class="J_menuItem top_menu" href="logout?action=signOut">
...
<!---------------------------------end menu------------------------------->
	   ...
	   <!--      <div class="row border-bottom">
            ...
            <div class="row" style="height: 20px; line-height: 36px;">
                <nav class="navbar navbar-static-top" style="margin-bottom: 0; min-height:35px;">
                    ...
                    <div class="pull-right " style="margin-right: 20px;"  >
                      Welcome,${uname} <a href="logout">退出</a>
         ...
         <div style="clear: both;"></div>
          ...
          <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" name="iframe0" data-index="0"  width="100%" height="100%" src="admin?action=gotoWelcomePage" frameborder="0" data-id="admin?action=gotoWelcomePage" seamless></iframe>
