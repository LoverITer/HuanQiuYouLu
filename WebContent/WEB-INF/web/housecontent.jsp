...
<div class="left">
	...
	<div id="house_imgs">
						...
						<div class="project_img">
								<dl>
								   <c:forEach items="${pic01}" var="pic">
								   	<dd><img src="../uppics/housepic/${pic.path }" class="img-responsive" alt="${pic.dis}"/></dd>
								   </c:forEach>
		...
		<div id="house_smallImg">
			<ul>
				<li>
				   <img src="../uppics/housepic/${title1.path}" alt="外景图"/>
				   <div class="bun_bg">外景图(${pic01.size()})</div>
				</li>
			
				<li>
					<img src="../uppics/housepic/${title2.path}" alt="样板间"/>
					<div class="bun_bg">样板间(${pic02.size()})</div>
				</li>
			
				<li>
					<img src="../uppics/housepic/${title3.path}" alt="户型图"/>
					<div class="bun_bg">户型图(${pic03.size()})</div>
				</li>
			
				<li>
					<img src="../uppics/housepic/${title4.path}" alt="周边配套"/>
					<div class="bun_bg">周边配套(${pic04.size()})</div>
				</li>
			
				<li>
					<img src="../uppics/housepic/${title5.path}" alt="区位图"/>
...
<div class="house_detil_list">
	  ...
	  <c:forEach items="${housetypes}" var="type">
			  <div class="huxing_show">
			  	   <img src="../uppics/housepic/${type.path}"  width="250" height="175"/>
